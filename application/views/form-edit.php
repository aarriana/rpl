...
<div id="container">
	...
	<?php if($dataEdit){
		...
		$materi = $dataEdit->materi;
		$kehadiran = $dataEdit->kehadiran;
	}else{
		$nama = "";
		$materi = "";
		$kehadiran = "";
		...
		<form action="<?php echo site_url('welcome/update/'.$id) ?>" method="POST">
			...
			Materi <br>
			<input type="text" name="materi" value="<?php echo $materi ?>"/><br>
			Kehadiran <br>
			<input type="text" name="kehadiran" value="<?php echo $kehadiran ?>"/><br>
			<input type="submit" name="simpan" value="Edit" />
		</form>
		<a href="<?php echo site_url('welcome/awal') ?>">Back</a>
	</div>
